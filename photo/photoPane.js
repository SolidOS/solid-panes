// Begin photoPane
//
//  (By albert08@csail.mit.edu)
//
var UI = require('solid-ui')

var photoPane = module.exports = {}
photoPane.icon = UI.icons.originalIconBase + 'photo_small.png'
...
var tag_bullet = UI.icons.originalIconBase + 'tag_tiny.png'
...
photoPane.render = function (subject, myDocument) {
  ...
  */
  ...
  photo_begin_img.setAttribute('src', UI.icons.originalIconBase + 'photo_begin.png')
  photo_begin_img.setAttribute('id', 'photoBeginButton')
  var photo_end_img = myDocument.createElement('img')
  photo_end_img.setAttribute('src', UI.icons.originalIconBase + 'photo_end.png')
  photo_end_img.setAttribute('id', 'photoEndButton')
  var photo_next_img = myDocument.createElement('img')
  photo_next_img.setAttribute('src', UI.icons.originalIconBase + 'photo_next.png')
  photo_next_img.setAttribute('id', 'photoNextButton')
  var photo_back_img = myDocument.createElement('img')
  photo_back_img.setAttribute('src', UI.icons.originalIconBase + 'photo_back.png')
