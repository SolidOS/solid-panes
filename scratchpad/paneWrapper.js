...
var paneWrapper = {
    ...
    label: function (subject) {
        if (!pane_1.pane.canHandle(subject, store)) {
            return null;
        }
        return pane_1.pane.label(subject, store);
    },
...
function visitNode(node) {
    var outliner = window.panes.getOutliner(document);
    outliner.GotoSubject(node, true, undefined, true, undefined);
}
exports["default"] = paneWrapper;
