...
var paneDef = {
    ...
    mintNew: function (newPaneOptions) {
        ...
        return new Promise(function (resolve, reject) {
            updater.put(newPadDoc, kb.statementsMatching(undefined, undefined, undefined, newPadDoc), 'text/turtle', function (uri2, ok, message) {
                if (ok) {
    ...
    render: function (subject, dom, paneOptions) {
        ...
        var setACL = function setACL(docURI, allWrite, callbackFunction) {
            ...
            if (aclDoc) { // Great we already know where it is
                ...
                return fetcher.webOperation('PUT', aclDoc.uri, { data: aclText, contentType: 'text/turtle' })
                    .then(function (_result) { return callbackFunction(true); })["catch"](function (err) {
        ...
        var showBootstrap = function showBootstrap(thisInstance, container, noun) {
            ...
            div.appendChild(UI.authn.newAppInstance(dom, appDetails, initializeNewInstanceInWorkspace));
        ...
        var initializeNewInstanceAtBase = function (thisInstance, newBase) {
            ...
            var newInstance = kb.sym(newPadDoc.uri + '#thisPad');
                ...
                var fun = function copyItem(item) {
                    agenda.push(function () {
                        ...
                        kb.fetcher.webCopy(base + item.local, newBase + item.local, item.contentType)
                            .then(function () { return UI.authn.checkUser(); })
                            .then(function (webId) {
                            me = webId;
                            setThatACL();
                        })["catch"](function (err) {
            ...
            agenda.push(function createNewPadDataFile() {
                ...
                updater.put(newPadDoc, kb.statementsMatching(undefined, undefined, undefined, newPadDoc), 'text/turtle', function (_uri2, ok, message) {
                    if (ok) {
                        agenda.shift()();
                    }
                    else {
