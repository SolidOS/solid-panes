...
import './questionBuilderPane.css'
/*   pad Pane
 **
 */

const questionBuilderPane: PaneDefinition = {
  ...
  // Does the subject deserve a builder pane?
  ...
  mintNew: function (context, newPaneOptions: any) {
    ...
    store.add(newInstance, ns.rdf('type'), ns.schema('Quiz'), newPadDoc)
...
export default questionBuilderPane
