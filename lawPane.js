...
LawPane.icon = UI.icons.originalIconBase + 'law.jpg';
LawPane.name = 'Law';
...
LawPane.render = function(subject, myDocument) {
    var kb = UI.store
	var collapse_icon = UI.icons.originalIconBase + 'tbl-collapse.png';
	var expand_icon = UI.icons.originalIconBase + 'tbl-expand-trans.png';
